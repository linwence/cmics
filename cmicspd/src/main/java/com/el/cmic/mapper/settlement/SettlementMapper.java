...
public interface SettlementMapper {
	...
	@Insert({ "insert into FE8SPD12 (JSUKID, JSEV01, ", "JSE8SPDID, JSE8ERPID, ", "JSE8JSDW, JSE8JSDWE, ",
			"JSE8JSDWBE, JSE8JSDWN, ", "JSE8CKYY, JSE8YHYYE, ", "JSE8YHYYN, JSE8YWBME, ", "JSE8YWBMN, JSE8YWYE, ",
			...
			"#{settlement.jse8jsdw,jdbcType=NCHAR}, #{settlement.jse8jsdwe,jdbcType=NCHAR}, ",
			"#{settlement.jse8jsdwbe,jdbcType=NCHAR}, #{settlement.jse8jsdwn,jdbcType=NCHAR}, ",
			"#{settlement.jse8ckyy,jdbcType=NCHAR}, #{settlement.jse8yhyye,jdbcType=NCHAR}, ",
			"#{settlement.jse8yhyyn,jdbcType=NCHAR}, #{settlement.jse8ywbme,jdbcType=NCHAR}, ",
			"#{settlement.jse8ywbmn,jdbcType=NCHAR}, #{settlement.jse8ywye,jdbcType=NCHAR}, ",
	...
	@Insert({ "insert into FE8SPD12 (JSUKID, JSEV01, ", "JSE8SPDID, JSE8ERPID, ", "JSE8JSDW, JSE8JSDWE, ",
			"JSE8JSDWBE, JSE8JSDWN, ", "JSE8CKYY, JSE8YHYYE, ", "JSE8YHYYN, JSE8YWBME, ", "JSE8YWBMN, JSE8YWYE, ",
			"JSE8YWYN, JSE8DDZHS, ", "JSE8XTSJ)", "values (#{jsukid,jdbcType=DECIMAL}, #{jsev01,jdbcType=NCHAR}, ",
			...
			"#{jse8ywyn,jdbcType=NCHAR}, #{jse8ddzhs,jdbcType=DECIMAL}, ", "#{jse8xtsj,jdbcType=DECIMAL})" })
	int insert(FE8SPD12 record);

	@Select({ "select", "JSUKID, JSEV01, JSE8SPDID, JSE8ERPID, JSE8JSDW, JSE8JSDWE, JSE8JSDWBE, JSE8JSDWN, ",
			"JSE8CKYY, JSE8YHYYE, JSE8YHYYN, JSE8YWBME, JSE8YWBMN, JSE8YWYE, JSE8YWYN, JSE8DDZHS, ", "JSE8XTSJ",
			"from FE8SPD12", "where JSUKID = #{jsukid,jdbcType=DECIMAL}" })
	@Results({ @Result(column = "JSUKID", property = "jsukid", jdbcType = JdbcType.DECIMAL, id = true),
	...
	@Update({ "update FE8SPD12", "set JSEV01 = #{jsev01,jdbcType=NCHAR},", "JSE8SPDID = #{jse8spdid,jdbcType=NCHAR},",
			"JSE8ERPID = #{jse8erpid,jdbcType=NCHAR},", "JSE8JSDW = #{jse8jsdw,jdbcType=NCHAR},",
			"JSE8JSDWE = #{jse8jsdwe,jdbcType=NCHAR},", "JSE8JSDWBE = #{jse8jsdwbe,jdbcType=NCHAR},",
			"JSE8JSDWN = #{jse8jsdwn,jdbcType=NCHAR},", "JSE8CKYY = #{jse8ckyy,jdbcType=NCHAR},",
			"JSE8YHYYE = #{jse8yhyye,jdbcType=NCHAR},", "JSE8YHYYN = #{jse8yhyyn,jdbcType=NCHAR},",
			"JSE8YWBME = #{jse8ywbme,jdbcType=NCHAR},", "JSE8YWBMN = #{jse8ywbmn,jdbcType=NCHAR},",
			"JSE8YWYE = #{jse8ywye,jdbcType=NCHAR},", "JSE8YWYN = #{jse8ywyn,jdbcType=NCHAR},",
			"JSE8DDZHS = #{jse8ddzhs,jdbcType=DECIMAL},", "JSE8XTSJ = #{jse8xtsj,jdbcType=DECIMAL}",
