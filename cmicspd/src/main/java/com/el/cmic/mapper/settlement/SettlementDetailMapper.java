...
public interface SettlementDetailMapper {
	...
	@Insert({ "insert into FE8SPD13 (JMUKID, JMRLLN, ", "JMEV01, JME8PSDW, JME8PSDWE, ", "JME8PSDWN, JME8CKKS, ",
			"JME8CKKSE, JME8CKKSN, ", "JME8CKDH, JME8CKRQ, ", "JME8CKLX, JME8SJLX, ", "JMLNID, JME8YYYCD, ",
			"JME8YYYCE, JME8YYYCN, ", "JME8SPDGG, JME8SCCS, ", "JME8SPDCD, JME8SPDDW, ", "JMLOT1, JMLOT2, JME8KCLX, ",
			"JME8YXQ, JME8SCRQ, ", "JME8SPDBZ, JMUORG)",
			"values (#{settlement.jsukid,jdbcType=DECIMAL}, #{settlementDetail.jmrlln,jdbcType=DECIMAL}, ",
			"#{settlementDetail.jmev01,jdbcType=NCHAR}, #{settlementDetail.jme8psdw,jdbcType=NCHAR}, #{settlementDetail.jme8psdwe,jdbcType=NCHAR}, ",
			"#{settlementDetail.jme8psdwn,jdbcType=NCHAR}, #{settlementDetail.jme8ckks,jdbcType=NCHAR}, ",
			"#{settlementDetail.jme8ckkse,jdbcType=NCHAR}, #{settlementDetail.jme8ckksn,jdbcType=NCHAR}, ",
			...
			"#{settlementDetail.jmlnid,jdbcType=DECIMAL}, #{settlementDetail.jme8yyycd,jdbcType=NCHAR}, ",
			"#{settlementDetail.jme8yyyce,jdbcType=NCHAR}, #{settlementDetail.jme8yyycn,jdbcType=NCHAR}, ",
