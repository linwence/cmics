...
public class FE8SPD10 implements Serializable {
    /**
    ...
    /**
     *  null - FE8SPD10.PHEIPSDW
     */
    private String pheipsdw;
    ...
    public String getPheipsdw() {
        return pheipsdw;
    }

    public void setPheipsdw(String pheipsdw) {
        this.pheipsdw = pheipsdw;
    }
    ...
    public Integer getPhe8xtsj() {
        return phe8xtsj;
    }

    public void setPhe8xtsj(Integer phe8xtsj) {
    ...
    public String toString() {
        ...
        sb.append(", pheipsdw=").append(pheipsdw);
