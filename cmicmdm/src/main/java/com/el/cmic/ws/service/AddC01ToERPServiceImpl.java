...
public class AddC01ToERPServiceImpl implements AddC01ToERPService{
    ...
    public String addC01ToERP(PhE001OutHeader phE001OutHeader, PhC001OutMain phC001OutMain,
     ...
     /*   try {*/
            ...
            if(phE001OutHeader.getFunctype().equals("ADD")) {
                updateFe80101SON(no);
                updateFe841003flag(no);
            }
        //if(phE001OutHeader.getFunctype().equals("MOD")){
            updateFe80101bgbs(no);
     //   }
        /*}catch (Exception e){
            logger.error("----------------------------------------------------------------------------------------------------");
    ...
    public String updateF0116(PhC001OutMain phC001OutMain, String no) {
        ...
        //f0116.setAlcty1(f0005Mapper.selectF0005(dbtype,"E8","DS",phC001OutMain.getPk_cities()));
    ...
    public String updateFE80101(PhE001OutHeader phE001OutHeader, PhC001OutMain phC001OutMain,
        ...
        if(phC001OutMain.getIsyy().equals("Y")) {
            ...
            if(!phC001OutSublineYY.getPhC001OutSublineYYList().get(0).getYynsr().equals("")) {
                long l = (Long.parseLong(phC001OutSublineYY.getPhC001OutSublineYYList().get(0).getYynsr())*100);
        ...
        if(phC001OutMain.getIsjcyljg().equals("Y")) {
            ...
            if(!phC001OutSublineJCYLJG.getPhC001OutJCYLJGC01List().get(0).equals("")) {
                long l = (Long.parseLong(phC001OutSublineJCYLJG.getPhC001OutJCYLJGC01List().get(0).getYynsr())*100);
...
/*        if(phE001OutHeader.getFunctype().equals("MOD")){
    ...
    public String updateFe80101bgbs(String no){
        ...
        fe80101UpdateByPKMapper.updateByPrimaryKeySelective(schema,fe80101,"N");
        return null;
    }
    @Transactional
    public String updateFe841003flag(String no){
        ...
        fe841003UpdateByPKMapper.updateByan8(schema,fe841003);
        return null;
    }
}
