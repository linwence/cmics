...
public interface Fe8log01Mapper {
    ...
    @SelectKey(statement="SELECT Fe8log01_Seq.NEXTVAL FROM DUAL", keyProperty="lgukid", before=true, resultType=BigDecimal.class)
    int insert(Fe8log01 record);
    ...
    Fe8log01 selectByPrimaryKey(BigDecimal lgukid);
    ...
    int updateByPrimaryKey(Fe8log01 record);
}