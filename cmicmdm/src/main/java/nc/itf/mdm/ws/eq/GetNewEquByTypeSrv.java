...
@XmlRootElement(name = "getNewEquByTypeSrv")
public class GetNewEquByTypeSrv {
    ...
    @XmlElementRef(name = "int1", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "string3", type = JAXBElement.class, required = false)
