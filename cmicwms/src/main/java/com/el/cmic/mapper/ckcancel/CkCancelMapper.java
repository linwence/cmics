...
public interface CkCancelMapper {
    final class SqlProvider extends SQL {
        ...
        public String selectCkCancelOrderList(@Param("co") String co) {
            SELECT("DISTINCT QCMCU AS MCU");
            SELECT("FE8WMS21.LSE8WLZXID AS WMSMCU");
    ...
    List<CkCancelOrder> selectCkCancelOrderList(@Param("co") String co);
