 ...
 */
@JSONType(orders = {"通知单行号", "货品编号", "申请取消数量", "实际取消数量", "库类型", "批号", "灭菌批号", "有效期至", "生产日期", "序列号明细"})
public class CkCancelBackOrderDtl {
    ...
    private List<CkCancelBackOrderSequence> ckCancelBackOrderSequenceList;
    ...
    public List<CkCancelBackOrderSequence> getCkCancelBackOrderSequenceList() {
        return ckCancelBackOrderSequenceList;
    }

    public void setCkCancelBackOrderSequenceList(List<CkCancelBackOrderSequence> ckCancelBackOrderSequenceList) {
        this.ckCancelBackOrderSequenceList = ckCancelBackOrderSequenceList;
    }
}
