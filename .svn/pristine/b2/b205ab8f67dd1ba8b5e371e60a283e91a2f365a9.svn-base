...
public interface SpdOrderDetailMapper {
	...
	@Insert({ "insert into FE8SPD11 (PHUKID, PHRLLN, PHLNID, ", "PHEV01, PHE8YLJGD, PHE8KSD, ", "PHE8ZDGYSE, PHE8ZDGYSN, ",
			"PHTRDJ, PHE8YYYCD, ", "PHE8YYYCE, PHE8YYYCN, ", "PHE8SGG, PHE8SCCS, PHE8SCD, ", "PHE8SDW, PHE8SBZ, ",
			"PHUPRC, PHUORG, ", "PHE8YJDHRQ)", "values (#{spdOrder.phukid,jdbcType=DECIMAL}, #{spdOrderDetail.phrlln,jdbcType=DECIMAL}, #{spdOrderDetail.phlnid,jdbcType=DECIMAL}, ",
			"NVL(#{spdOrderDetail.phev01,jdbcType=NCHAR}, 'N'), #{spdOrderDetail.phe8yljgd,jdbcType=NCHAR}, #{spdOrderDetail.phe8ksd,jdbcType=NCHAR}, ",
			"#{spdOrderDetail.phe8zdgyse,jdbcType=NCHAR}, #{spdOrderDetail.phe8zdgysn,jdbcType=NCHAR}, ",
			"#{spdOrderDetail.phtrdjj,jdbcType=DECIMAL}, #{spdOrderDetail.phe8yyycd,jdbcType=NCHAR}, ",
			"#{spdOrderDetail.phe8yyyce,jdbcType=NCHAR}, #{spdOrderDetail.phe8yyycn,jdbcType=NCHAR}, ",
	...
	@Select({ "select", "PHUKID, PHLNID, PHEV01, PHE8YLJGD, PHE8KSD, PHE8ZDGYSE, PHE8ZDGYSN, PHTRDJ, ",
			...
			"PHUPRC, PHUORG, PHE8YJDHRQ", "from FE8SPD11", "where PHUKID = #{phukid,jdbcType=DECIMAL}",
			"and PHLNID = #{phlnid,jdbcType=DECIMAL}" })
