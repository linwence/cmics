 ...
 * @author zhanhao
 */
@JSONType(orders = {"物流中心", "入库类型", "货主", "通知单号", "客户编号", "客户名称", "业务员", "通知单日期", "订单类型", "通知单明细", "序列号明细"},
...
public class InInvertoryCancel {
    ...
    public BigDecimal getQxan8() {
        return qxan8;
    }

    public void setQxan8(BigDecimal qxan8) {
        this.qxan8 = qxan8;
    }
