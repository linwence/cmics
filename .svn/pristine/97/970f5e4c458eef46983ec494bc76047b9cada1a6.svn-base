 ...
 */
@JSONType(orders = {"SPD系统标识", "配送单位", "配送单位名称", "要货医院ERP编号","要货医院名称","要货科室ERP标号"
        ,"要货科室名称","收货科室ERP编号","收货科室名称","采购订单号","请购类型","_date"
        ,"订单总行数","采购订单明细"},ignores = { "kcoo", "doco", "dcto"})
...
public class SpdOrderBack implements Serializable {
    ...
    public String getE8shks() {
        return e8shks;
    }

    public void setE8shks(String e8shks) {
        this.e8shks = e8shks;
    }
