 ...
 * 2016-09-02T11:02:42.507+08:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "EmpWsServiceImplService", 
                  wsdlLocation = "http://localhost:8080/cmicspd/ws/EmpWebService?wsdl",
                  targetNamespace = "http://ws.cmic.el.com/") 
public class EmpWsServiceImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws.cmic.el.com/", "EmpWsServiceImplService");
    public final static QName EmpWsServiceImplPort = new QName("http://ws.cmic.el.com/", "EmpWsServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/cmicspd/ws/EmpWebService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EmpWsServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/cmicspd/ws/EmpWebService?wsdl");
        }
        WSDL_LOCATION = url;
    }
