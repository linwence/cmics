...
public interface SpdOrderMapper {
	...
	@Insert({ "insert into FE8SPD10 (PHUKID, PHEV01, ", "PHE8SPDID, PHE8ERPID, ", "PHE8PSDW, PHE8PSDWE, ",
			"PHE8PSDWN, PHE8YHYY, ", "PHE8YHYYE, PHE8YHYYN, ", "PHE8YHKS, PHE8YHKSE, ", "PHE8YHKSN, PHE8SHKS, ",
			"PHE8SHKSE, PHE8SHKSN, ", "PHE8YWBME, PHE8YWBMN, ", "PHE8YWYE, PHE8YWYN, ", "PHE8CGDD, PHE8QGLX, ",
			...
			"#{spdOrder.phe8psdw,jdbcType=NCHAR}, #{spdOrder.phe8psdwe,jdbcType=NCHAR}, ",
			"#{spdOrder.phe8psdwn,jdbcType=NCHAR}, #{spdOrder.phe8yhyy,jdbcType=NCHAR}, ",
			"#{spdOrder.phe8yhyye,jdbcType=NCHAR}, #{spdOrder.phe8yhyyn,jdbcType=NCHAR}, ",
			"#{spdOrder.phe8yhks,jdbcType=NCHAR}, #{spdOrder.phe8yhkse,jdbcType=NCHAR}, ",
			"#{spdOrder.phe8yhksn,jdbcType=NCHAR}, #{spdOrder.phe8shks,jdbcType=NCHAR}, ",
			"#{spdOrder.phe8shkse,jdbcType=NCHAR}, #{spdOrder.phe8shksn,jdbcType=NCHAR}, ",
			"#{spdOrder.phe8ywbme,jdbcType=NCHAR}, #{spdOrder.phe8ywbmn,jdbcType=NCHAR}, ",
			"#{spdOrder.phe8ywye,jdbcType=NCHAR}, #{spdOrder.phe8ywyn,jdbcType=NCHAR}, ",
