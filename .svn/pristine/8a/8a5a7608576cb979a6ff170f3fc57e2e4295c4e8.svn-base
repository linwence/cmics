...
public interface RevertDataDetailMapper {
	...
	@Insert("insert  into FE8SPD15(QMUKID,QMRLLN,QMEV01,QMLNID,QME8YYQGD,QME8KSQGD,QME8YYYCD,QME8YYYCE,QME8YYYCN,QME8SPDGG,"
			+ "QME8SCCS,QME8SPDCD,QME8SPDDW,QMLOT1,QMLOT2,QME8KCLX,QME8YXQ,QME8SCRQ,QME8SPDBZ,QMUORG,QME8RKLX) "
			+ "values (#{revertDataDetail.qmukid ,jdbcType=DECIMAL},#{revertDataDetail.qmrlln ,jdbcType=DECIMAL},"
			+ "NVL(#{revertDataDetail.qmev01 ,jdbcType=NCHAR}, 'N'),#{revertDataDetail.qmlnid ,jdbcType=NCHAR},"
			+ "#{revertDataDetail.qme8yyqgd ,jdbcType=NCHAR},#{revertDataDetail.qme8ksqgd ,jdbcType=NCHAR},"
			+ "#{revertDataDetail.qme8yyycd ,jdbcType=NCHAR},#{revertDataDetail.qme8yyyce ,jdbcType=NCHAR},"
			...
			+ "#{revertDataDetail.qme8spdbz ,jdbcType=DECIMAL},#{revertDataDetail.qmuorg ,jdbcType=DECIMAL},"
