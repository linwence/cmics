...
public interface Fe84101Mapper {
    @Select({
        ...
        "SPFLAG, SPE8SCG, SPE8CPDL, SPE8TSFL, SPE8CPFL, SPEMCU, SPAN82, SPITM, SPE8SPTYM, ",
        "SPE8STR200",
        "from FE84101",
    ...
    @Results({
        ...
        @Result(column="SPEMCU", property="spemcu", jdbcType=JdbcType.NCHAR),
        @Result(column="SPAN82", property="span82", jdbcType=JdbcType.DECIMAL),
        @Result(column="SPITM", property="spitm", jdbcType=JdbcType.DECIMAL),
        @Result(column="SPE8SPTYM", property="spe8sptym", jdbcType=JdbcType.NCHAR),
        @Result(column="SPE8STR200", property="spe8str200", jdbcType=JdbcType.NCHAR)
    })
