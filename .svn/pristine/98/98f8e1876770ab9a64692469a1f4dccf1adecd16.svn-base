...
public interface FE8SPD13Mapper {
    ...
    @Insert({
        "insert into FE8SPD13 (JMUKID, JMRLLN, ",
        "JMEV01, JME8PSDW, JME8PSDWE, ",
        "JME8PSDWN, JME8CKKS, ",
        "JME8CKKSE, JME8CKKSN, ",
        "JME8CKDH, JME8CKRQ, ",
        "JME8CKLX, JME8SJLX, ",
        ...
        "JME8SPDGG, JME8SCCS, ",
        "JME8SPDCD, JME8SPDDW, ",
        "JMLOT1, JMLOT2, JME8KCLX, ",
        "JME8YXQ, JME8SCRQ, ",
        "JME8SPDBZ, JMUORG)",
        "values (#{jmukid,jdbcType=DECIMAL}, #{jmrlln,jdbcType=DECIMAL}, ",
        "#{jmev01,jdbcType=NCHAR}, #{jme8psdw,jdbcType=NCHAR}, #{jme8psdwe,jdbcType=NCHAR}, ",
        "#{jme8psdwn,jdbcType=NCHAR}, #{jme8ckks,jdbcType=NCHAR}, ",
        "#{jme8ckkse,jdbcType=NCHAR}, #{jme8ckksn,jdbcType=NCHAR}, ",
        "#{jme8ckdh,jdbcType=NCHAR}, #{jme8ckrq,jdbcType=DECIMAL}, ",
        "#{jme8cklx,jdbcType=DECIMAL}, #{jme8sjlx,jdbcType=DECIMAL}, ",
        "#{jmlnid,jdbcType=DECIMAL}, #{jme8yyycd,jdbcType=NCHAR}, ",
        "#{jme8yyyce,jdbcType=NCHAR}, #{jme8yyycn,jdbcType=NCHAR}, ",
        "#{jme8spdgg,jdbcType=NCHAR}, #{jme8sccs,jdbcType=NCHAR}, ",
        "#{jme8spdcd,jdbcType=NCHAR}, #{jme8spddw,jdbcType=NCHAR}, ",
        "#{jmlot1,jdbcType=NCHAR}, #{jmlot2,jdbcType=NCHAR}, #{jme8kclx,jdbcType=NCHAR}, ",
        "#{jme8yxq,jdbcType=DECIMAL}, #{jme8scrq,jdbcType=DECIMAL}, ",
        "#{jme8spdbz,jdbcType=DECIMAL}, #{jmuorg,jdbcType=DECIMAL})"
    })
    int insert(FE8SPD13 record);
    ...
    @Update({
        "update FE8SPD13",
        "set JMEV01 = #{jmev01,jdbcType=NCHAR},",
          "JME8PSDW = #{jme8psdw,jdbcType=NCHAR},",
          "JME8PSDWE = #{jme8psdwe,jdbcType=NCHAR},",
          "JME8PSDWN = #{jme8psdwn,jdbcType=NCHAR},",
          "JME8CKKS = #{jme8ckks,jdbcType=NCHAR},",
          "JME8CKKSE = #{jme8ckkse,jdbcType=NCHAR},",
          "JME8CKKSN = #{jme8ckksn,jdbcType=NCHAR},",
          "JME8CKDH = #{jme8ckdh,jdbcType=NCHAR},",
          "JME8CKRQ = #{jme8ckrq,jdbcType=DECIMAL},",
          "JME8CKLX = #{jme8cklx,jdbcType=DECIMAL},",
          "JME8SJLX = #{jme8sjlx,jdbcType=DECIMAL},",
          "JMLNID = #{jmlnid,jdbcType=DECIMAL},",
          "JME8YYYCD = #{jme8yyycd,jdbcType=NCHAR},",
          "JME8YYYCE = #{jme8yyyce,jdbcType=NCHAR},",
          "JME8YYYCN = #{jme8yyycn,jdbcType=NCHAR},",
          "JME8SPDGG = #{jme8spdgg,jdbcType=NCHAR},",
          "JME8SCCS = #{jme8sccs,jdbcType=NCHAR},",
          "JME8SPDCD = #{jme8spdcd,jdbcType=NCHAR},",
          "JME8SPDDW = #{jme8spddw,jdbcType=NCHAR},",
          "JMLOT1 = #{jmlot1,jdbcType=NCHAR},",
          "JMLOT2 = #{jmlot2,jdbcType=NCHAR},",
          "JME8KCLX = #{jme8kclx,jdbcType=NCHAR},",
          "JME8YXQ = #{jme8yxq,jdbcType=DECIMAL},",
          "JME8SCRQ = #{jme8scrq,jdbcType=DECIMAL},",
          "JME8SPDBZ = #{jme8spdbz,jdbcType=DECIMAL},",
          "JMUORG = #{jmuorg,jdbcType=DECIMAL}",
        "where JMUKID = #{jmukid,jdbcType=DECIMAL}",
          "and JMRLLN = #{jmrlln,jdbcType=DECIMAL}"
    })
