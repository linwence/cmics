...
public interface CkBackMapper {
    ...
    final class SqlProvider extends SQL {
        ...
        public String insertF47132(@Param("ckBackOrder") CkBackOrder ckBackOrder, @Param("ckBackOrderDtl") CkBackOrderDtl ckBackOrderDtl) {
            INSERT_INTO("F47132");
            ...
            VALUES("SZUPMJ", UPMJ);
            VALUES("SZTDAY", TDAY);
            VALUES("SZEDLN", "#{ckBackOrderDtl.lnid}");
        ...
        public String insertF47072(@Param("ckBackOrder") CkBackOrder ckBackOrder, @Param("ckBackOrderDtl") CkBackOrderDtl ckBackOrderDtl) {
            INSERT_INTO("F47072");
            VALUES("szekco", "(select LSCO from FE8WMS20 where trim(LSE8HZBM) = #{ckBackOrder.wmskcoo})");
            VALUES("szedoc", "#{ckBackOrder.syedoc}");
            VALUES("SZEDCT", "#{ckBackOrder.dcto}");
    ...
    int insertF47132(@Param("ckBackOrder") CkBackOrder ckBackOrder, @Param("ckBackOrderDtl") CkBackOrderDtl ckBackOrderDtl);
    ...
    int insertF47072(@Param("ckBackOrder") CkBackOrder ckBackOrder, @Param("ckBackOrderDtl") CkBackOrderDtl ckBackOrderDtl);
