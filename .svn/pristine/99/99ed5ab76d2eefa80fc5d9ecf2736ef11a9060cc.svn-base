 ...
 */
public class PhC001OutYYC01 {
    private String isyl;
    private String isgl;
    private String issbdd;
    private String pk_yygs;
    private String pk_yljb;
    private String istgyf;
    private String pk_yydl;
    private String pk_yyxl;
    private String yynsr;
    private String isyljgz;
    private String isyyzz;
    private String iszzjgdm;
    private String isswdjz;
    private String isxbyyzz;
